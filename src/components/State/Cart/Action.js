...
export const findCart = (token) => {
  return async (dispatch) => {
    ...
    try {
      ...
      console.log("find cart: " + JSON.stringify(response.data));
...
export const getAllCartItems = (reqData) => {
  return async (dispatch) => {
    ...
    try {
      ...
      console.log("all cart cart: " + response.data);
...
export const addItemToCart = (reqData) => {
  return async (dispatch) => {
    ...
    try {
      ...
      console.log("add item to cart: " + JSON.stringify(data));
...
export const removeCartItem = ({ cartItemId, jwt }) => {
  return async (dispatch) => {
    ...
    try {
      ...
      console.log("remove cart item: " + JSON.stringify(data));
